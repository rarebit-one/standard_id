...
- **fundbright-web, luminality-web:** `bin/rails standard_id:install:migrations` — `20260414200000` was never installed; the new boot check will say so in development.
